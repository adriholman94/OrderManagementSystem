...
@Entity
@Table(name = "users")
public class Users implements BaseBeans {
	...
	public String toString() {
		return "user[id=" + userId + ", userName=" + userName + ", userPassword=" + userPassword + ", firstName="
				+ firstName + ", lastName =" + lastName + ", userPhone =" + userPhone + ", userMail =" + userMail
				+ ", _clients =" + _clients + ", _admin =" + _admin + "]";
	}
